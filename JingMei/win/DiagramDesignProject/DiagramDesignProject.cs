...
{
    public partial class DiagramDesignProject : Form
    {
        private WF.ProjectStatusEnum statu=WF.ProjectStatusEnum.DiagramDesignProject;
        public DiagramDesignProject()
        {
            InitializeComponent();
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            check(WF.ProjectStatusEnum.DemoMaker);
            bind();
        }
        ...
        {
            check(WF.ProjectStatusEnum.DiagramDesignProject);
            bind();
        }
