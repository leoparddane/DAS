...
namespace WF.UserService.Activities {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class checkPwd : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.InArgument<string> _pwd;
        
        private System.Activities.OutArgument<bool> _checkPwdResult;
...
partial void AfterInitializeComponent();
        ...
        [System.ComponentModel.DefaultValueAttribute("UserService")]
        ...
        [System.Activities.RequiredArgumentAttribute()]
        public System.Activities.InArgument<string> pwd {
            get {
                return this._pwd;
            }
            set {
        ...
        public System.Activities.OutArgument<bool> checkPwdResult {
            get {
                return this._checkPwdResult;
            }
            set {
                this._checkPwdResult = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(checkPwd).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(checkPwd));
        ...
        private string FindResource() {
            string[] resources = typeof(checkPwd).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".WF.UserService.IUser.checkPwd.g.xaml") || resource.Equals("WF.UserService.IUser.checkPwd.g.xaml"))) {
                    return resource;
                }
            }
