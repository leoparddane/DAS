...
namespace WF {
    ...
    public partial class Project : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<object> _projectModel;
        
        private System.Activities.OutArgument<bool> _o;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<object> projectModel {
            get {
        ...
        public System.Activities.OutArgument<bool> o {
            get {
                return this._o;
            }
            set {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Project).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Project));
        ...
        private string FindResource() {
            string[] resources = typeof(Project).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".projectActivity.g.xaml") || resource.Equals("projectActivity.g.xaml"))) {
                    return resource;
                }
            }
